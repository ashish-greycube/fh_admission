		...
		LEFT JOIN
			(
				SELECT
					...
					SUM(CASE WHEN (l.status IN ("Replied", "Lead", "Coverted", "Confirmed", "Admission Form Fee Paid", "Contacted", "To Follow-up", "Waitlist")) THEN 1 ELSE 0 END) AS qualified_leads,
					SUM(CASE WHEN l.status IN ("Confirmed", "Converted", "Admission Form Fee Paid") THEN 1 ELSE 0 END) AS admissions_confirmed,
